...
return [
    ...
    'map'     => [
        ...
        'bulksmsbd'          => \App\Http\Controllers\Settings\SMS\Drivers\BulksmsBD::class,
        'nexmo'              => \App\Http\Controllers\Settings\SMS\Drivers\Nexmo::class,
        'infobip'            => \App\Http\Controllers\Settings\SMS\Drivers\Infobip::class,
        'messagebird'        => \App\Http\Controllers\Settings\SMS\Drivers\Messagebird::class,
        'bulksmsnigeria'     => \App\Http\Controllers\Settings\SMS\Drivers\Bulksmsnigeria::class,
        'nigeriabulksms'     => \App\Http\Controllers\Settings\SMS\Drivers\Nigeriabulksms::class,
        'httpurl'            => \App\Http\Controllers\Settings\SMS\Drivers\HttpURL::class,
    ],
];
