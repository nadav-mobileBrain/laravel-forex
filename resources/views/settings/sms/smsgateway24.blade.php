            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">Api Token</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" name="data[token]" value="{{ $gateway->data ? $gateway->data['token'] : '' }}" required type="text">
                                    <span class="input-group-addon"><b><i class="fa fa-code"></i></b></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">Default Device ID</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" name="data[deviceid]" value="{{ $gateway->data ? $gateway->data['deviceid'] : '' }}" required type="text">
                                    <span class="input-group-addon"><b><i class="fa fa-code"></i></b></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">Device SIM Slot</strong></label>
                            <div class="col-md-12">
                                <select name="data[sim]" id="" class="form-control">
                                    <option value="0" {{ $gateway?->data['sim'] == 0 ? 'selected' : '' }}>SIM 1</option>
                                    <option value="1" {{ $gateway?->data['sim'] == 1 ? 'selected' : '' }}>SIM 2</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
