            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                            ...
                            <table class="table table-striped bg-info table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td> @{{message}} </td>
                                        <td>Replace message query.</td>
                                        <td>Which Text User Receive.</td>
                                    </tr>
                        ...
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">HTTP URL</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" name="data[url]" value="{{ $gateway->data ? $gateway->data['url'] : '' }}" required type="text">
