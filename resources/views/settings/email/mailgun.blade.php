            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <hr>
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">MAILGUN DOMAIN</strong></label>
                            <div class="col-md-12">
                                <input name="data[domain]" value="{{ $driver->data ? $driver->data['domain'] : '' }}" class="form-control input-lg" placeholder="MAILGUN Host Port" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">MAILGUN SECRET</strong></label>
                            <div class="col-md-12">
                                <input name="data[secret]" value="{{ $driver->data ? $driver->data['secret'] : '' }}" class="form-control input-lg" placeholder="MAILGUN Host Port" />
                            </div>
                        </div>
                        <div class="form-group">
