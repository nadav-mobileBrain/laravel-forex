                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input name="data[host]" value="{{ $driver->data['host'] }}" class="form-control input-lg" placeholder="SMTP Host" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">SMTP Host Port </strong></label>
                            <div class="col-md-12">
                                <input name="data[port]" value="{{ $driver->data['port'] }}" class="form-control input-lg" placeholder="SMTP Host Port" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">SMTP Username </strong></label>
                            <div class="col-md-12">
                                <input name="data[username]" value="{{ $driver->data['username'] }}" class="form-control input-lg" placeholder="SMTP Username" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">SMTP Password </strong></label>
                            <div class="col-md-12">
                                <input name="data[password]" value="{{ $driver->data['password'] }}" class="form-control input-lg" placeholder="SMTP Password" type="text" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">SMTP Encryption </strong></label>
                            <div class="col-md-12">
                                <input name="data[encryption]" value="{{ $driver->data['encryption'] }}" class="form-control input-lg" placeholder="SMTP Encryption" />
                            </div>
                        </div>
                        <div class="form-group">
