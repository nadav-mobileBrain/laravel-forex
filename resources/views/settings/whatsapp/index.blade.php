                                ...
                                <tbody>
                                    @foreach ($drivers as $key => $driver)
                                        <tr class="{{ $driver->status == 0 ? 'bg-warning' : '' }}">
                                            <td><b>{{ ++$key }}</b></td>
                                            <td><img src="{{ asset('assets/images/settings/whatsapp') }}/{{ $driver->image }}" width="120px" alt=""></td>
                                            ...
                                            <td>
                                                <a href="{{ route('edit-whatsapp-drivers', $driver->id) }}" class="btn btn-primary text-bold-700 btn-mini text-uppercase"><i class='fa fa-send font-medium-1'></i> <span>Edit Driver</span></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
