            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <hr>
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">TOKEN</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                        ...
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">INSTANCE ID</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" name="data[instance]" value="{{ $driver->data ? $driver->data['instance'] : '' }}" required type="text">
                                    <span class="input-group-addon"><b><i class="fa fa-code"></i></b></span>
                                </div>
                            </div>
                        </div>
