                            ...
                            <form class="form form-horizontal" action="{{ route('user-update-profile') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control text-right" for="projectinput1"><b>Full Name : </b></label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" id="projectinput1" class="form-control" value="{{ $admin->username }}" placeholder="User Name" name="username" required readonly>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-md-3 label-control text-right" for="projectinput2"><b>User Email : </b></label>
                                        <div class="col-md-8">
                                            <input type="email" id="projectinput2" readonly class="form-control" value="{{ $admin->email }}" placeholder="Email" name="email" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control text-right" for="projectinput1"><b>User Phone : </b></label>
                                        <div class="col-md-2">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control text-right" for="projectinput2"><b>User Picture : </b></label>
                                        <div class="col-md-8">
