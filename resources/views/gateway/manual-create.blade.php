                    ...
                    <div class="card-block">
                        ...
                        {!! Form::open(['method'=>'post', 'role'=>'form', 'class'=>'form-horizontal', 'files'=>true]) !!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control has-error bold" rows="5" id="description" name="val1" placeholder="Payment Description (eg: Bank Payment Details)" required></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-8 offset-3">
                                    <button type="submit" class="btn btn-primary btn-block bold uppercase" id="btn-save" value="add"><i class="fa fa-send"></i> Create Gateway</button>
                                </div>
                            </div>
