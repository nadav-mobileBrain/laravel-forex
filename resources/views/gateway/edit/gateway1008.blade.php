            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">ACCEPT CRYPTO</strong></label>
                            <div class="col-md-12">
                                <select name="val3" id="currency" class="form-control">
                                    <option value="Litecoin" {{ $payment->val3 == 'Litecoin' ? 'selected' : '' }}>Litecoin</option>
                                    <option value="Bitcoin" {{ $payment->val3 == 'Bitcoin' ? 'selected' : '' }}>Bitcoin</option>
                                    <option value="Dogecoin" {{ $payment->val3 == 'Dogecoin' ? 'selected' : '' }}>Dogecoin</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-12">
                                <strong style="text-transform: uppercase;">BLOCKIO API KEY: <code id="updateCurrency">{{ $payment->val3 }}</code></strong>
                            </label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                        ...
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">BLOCKIO SECRET PIN</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                        ...
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">BLOCKIO CRON COMMAND</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" name="" value="wget -O /dev/null {{ route('blockio-ipn') }}" readonly type="text">
