            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">PAYSTACK PUBLIC KEY</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                        ...
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">PAYSTACK SECRET KEY</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                        ...
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">PAYSTACK MERCHANT EMAIL</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                        ...
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">Callback & Webhook URL</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" value="{{ route('paystack-ipn') }}" readonly type="text">
