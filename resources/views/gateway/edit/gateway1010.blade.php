                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group">
                            <label class="col-md-12">
                                <strong style="text-transform: uppercase;">VoguePay Merchant Id</strong>
                            </label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                        ...
                        <div class="form-group" style="display:none">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">VoguePay Developer CODE</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                        ...
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">VoguePay WEBHOOK</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" name="ipn" value="{{ route('voguepay-ipn') }}" readonly type="text">
