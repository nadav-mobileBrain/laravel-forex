            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select name="val3" id="" class="form-control">
                                    ...
                                    <option value="production" {{ $payment->val3 == 'production' ? 'selected' : '' }}>Production</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">ZARIN GATE</strong></label>
                            <div class="col-md-12">
                                <select name="val2" id="" class="form-control">
                                    <option value="enable" {{ $payment->val2 == 'enable' ? 'selected' : '' }}>Enable</option>
                                    <option value="disable" {{ $payment->val2 == 'disable' ? 'selected' : '' }}>Disable</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
