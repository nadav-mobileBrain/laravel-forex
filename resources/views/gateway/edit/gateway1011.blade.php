                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    ...
                                    <span class="input-group-addon"><strong id="updateCurrency">INR</strong></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select name="val3" id="" class="form-control">
                                    <option value="sandbox" {{ $payment->val3 == 'sandbox' ? 'selected' : '' }}>Sandbox</option>
                                    <option value="live" {{ $payment->val3 == 'live' ? 'selected' : '' }}>Live</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12">
                                <strong style="text-transform: uppercase;">Client ID</strong>
                            </label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                        ...
                        <div class="form-group" style="display:block">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">Client Secret</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
