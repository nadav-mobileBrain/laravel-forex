                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input class="form-control" name="name" value="{{ $payment->name }}" type="text" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" name="val1" value="{{ $payment->val1 }}" required type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" name="val2" value="{{ $payment->val2 }}" required type="text">
                                    <span class="input-group-addon"><b><i class="fa fa-code"></i></b></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select name="val3" id="val3" class="form-control">
                                    <option {{ $payment->val3 == 'live' ? 'selected' : '' }} value="live">Live</option>
                                    <option {{ $payment->val3 == 'sandbox' ? 'selected' : '' }} value="sandbox">Sandbox</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input data-toggle="toggle" {{ $payment->status == 1 ? 'checked' : '' }} data-onstyle="success" data-on="Activate" data-off="Deactivate" data-offstyle="danger" data-width="100%" type="checkbox" name="status">
                            </div>
                        </div>
                        <hr>
                        <div class="form-group">
