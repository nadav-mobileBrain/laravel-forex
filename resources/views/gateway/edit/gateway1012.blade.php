                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group">
                            <label class="col-md-12">
                                <strong style="text-transform: uppercase;">Payout Secret Key</strong>
                            </label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                        ...
                        <div class="form-group" style="display:block">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">Web ID</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                        ...
                        <div class="form-group" style="display:block">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">Cashmaal IPN URL</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" name="" value="{{ route('cashmaal-ipn') }}" readonly type="text">
