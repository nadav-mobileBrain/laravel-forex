            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">PAYTM ENVIRONMENT</strong></label>
                            <div class="col-md-12">
                                <select name="extra[env]" id="" class="form-control">
                                    <option value="local" {{ $payment->extra['env'] == 'local' ? 'selected' : '' }}>Local</option>
                                    <option value="production" {{ $payment->extra['env'] == 'production' ? 'selected' : '' }}>Production</option>
                                </select>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">PAYTM MERCHANT ID</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                        ...
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">PAYTM MERCHANT KEY</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" name="val2" value="{{ $payment->val2 }}" type="text">
                                    <span class="input-group-addon"><i class="fa fa-key"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">PAYTM MERCHANT WEBSITE</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" name="val3" value="{{ $payment->val3 }}" type="text">
                                    <span class="input-group-addon"><i class="fa fa-desktop"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group" style="display: none">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">PAYTM CHANNEL</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" name="extra[channel]" value="{{ $payment->extra['channel'] }}" type="text">
                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group" style="display: none">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">PAYTM INDUSTRY TYPE</strong></label>
                            <div class="col-md-12">
                                <div class="input-group mb15">
                                    <input class="form-control" name="extra[industry_type]" value="{{ $payment->extra['industry_type'] }}" type="text">
                                    <span class="input-group-addon"><i class="fa fa-info"></i></span>
                                </div>
                            </div>
                        </div>
