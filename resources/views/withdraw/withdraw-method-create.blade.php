            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('withdraw-method') }}" class="btn btn-primary bold"><i class="fa fa-th-list"></i> All Withdraw Gateway</a>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <button type="submit" class="btn btn-primary bg-softwarezon-x btn-lg btn-block "> <i class="fa fa-send"></i> Save Withdraw Method</button>
                                            </div>
                                        </div>
                                    </div>
                                    {!! Form::close() !!}
