            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('withdraw-create') }}" class="btn btn-primary bold"><i class="fa fa-plus"></i> Add New Gateway</a>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                @foreach($withdraw as $key => $pm)
                                    <tr class="{{$pm->status == 0 ? 'bg-warning' : ''}}">
                                        ...
                                        <td>
                                            <a href="{{ route('withdraw-edit',$pm->id) }}" class="btn btn-primary btn-mini font-weight-bold"><i class="fa fa-edit"></i> EDIT</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
