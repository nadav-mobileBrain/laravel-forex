            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        <form class="form form-horizontal" action="{{ route('staff-user-create') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 label-control text-right" for="projectinput1"><b>Username : </b></label>
                                    <div class="col-md-8">
                                        <input type="text" id="projectinput1" class="form-control font-weight-bold" value="" placeholder="Username" name="username" required>
                                    </div>
                                </div>
                                <div class="form-group row">
