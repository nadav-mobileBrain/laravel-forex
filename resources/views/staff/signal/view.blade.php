                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <a href="{{ route('staff-signal-edit', $signal->custom) }}" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
                                            ...
                                            <li>
                                                <div class="comment-main-level">
                                                    ...
                                                    <div class="comment-box">
                                                        ...
                                                        <div class="comment-content">
                                                            <form action="{{ route('staff-comment-submit') }}" method="post">
                                                                {!! csrf_field() !!}
                                                ...
                                                @if ($com->user_id == 0)
                                                    <li>
                                                        <div class="comment-main-level">
                                                            ...
                                                            <div class="comment-box">
                                                                <div class="comment-head">
                                                                    <h6 class="comment-name">{{ Auth::user()->name }} - {!! \App\TraitsFolder\CommonTrait::getRating($com->rating) !!} ({{ $com->rating }})</h6>
                                                                    <span style="margin-top: -4px;">{{ \Carbon\Carbon::parse($com->created_at)->diffForHumans() }}</span>
                                                                </div>
                                                                <div class="comment-content">
                                                                    {{ $com->comment }}
                                                ...
                                                <li>
                                                    <div class="comment-main-level">
                                                        ...
                                                        <div class="comment-box">
                                                            ...
                                                            <div class="comment-content">
                                                                <form action="{{ route('staff-rating-submit') }}" method="post">
                                                                    {!! csrf_field() !!}
                                                                    <input type="hidden" name="signal_id" value="{{ $signal->id }}">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('staff-signal-delete') }}" class="form-inline">
                        {!! csrf_field() !!}
                        {{ method_field('DELETE') }}
    ...
    <div class="modal fade" id="ResultModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('staff-signal-result') }}" method="post">
                    @csrf
                    <div class="modal-body">
    ...
    <div class="modal fade" id="ShowModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('staff-signal-home') }}" method="post">
                    @csrf
                    <div class="modal-body">
                        <input type="hidden" name="signal_id" class="signal_id" value="0">
                        <div class="form-group">
