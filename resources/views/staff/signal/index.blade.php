                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="btn-group btn-group-sm d-flex justify-content-center" role="group" aria-label="Basic example">
                                                    ...
                                                    <a href="{{ route('staff-signal-view', $p->custom) }}" class="btn btn-primary btn-mini" title="View"><i class="fa fa-eye"></i> Details</a>
                                                    <a href="{{ route('staff-signal-edit', $p->custom) }}" class="btn btn-warning btn-mini" title="Edit"><i class="fa fa-edit"></i> Edit</a>
