            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <form action="{{ route('staff-post-update') }}" method="post" role="form" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input data-toggle="toggle" {{ $testimonial->fetured == 1 ? 'checked' : '' }} data-onstyle="success" data-size="large" data-offstyle="danger" data-on="Activated" data-off="Deactivated" data-width="100%" type="checkbox" name="fetured">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input data-toggle="toggle" {{ $testimonial->status == 1 ? 'checked' : '' }} data-onstyle="success" data-size="large" data-offstyle="danger" data-on="Activated" data-off="Deactivated" data-width="100%" type="checkbox" name="status">
                                            </div>
                                        </div>
