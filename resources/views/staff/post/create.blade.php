            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        {!! Form::open(['route' => 'staff-post-store', 'method' => 'post', 'role' => 'form', 'class' => 'form-horizontal', 'files' => true]) !!}
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail" style="width: 400px; height: 220px;" data-trigger="fileinput">
                                                    <img style="width: 400px" src="https://via.placeholder.com/400x220/EFEFEF/AAAAAA?text=Image" alt="...">
                                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="description" id="area1" cols="3" rows="10" class="form-control" required placeholder="Description"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="tags" data-role="tagsinput" placeholder="Tags coma (,) Separate" class="form-control input-lg"required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input data-toggle="toggle" data-onstyle="success" data-size="large" data-offstyle="danger" data-on="Activated" data-off="Deactivated" data-width="100%" type="checkbox" name="fetured">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input data-toggle="toggle" data-onstyle="success" data-size="large" data-offstyle="danger" data-on="Activated" data-off="Deactivated" data-width="100%" type="checkbox" name="status">
                                        </div>
                                    </div>
