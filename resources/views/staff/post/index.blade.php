                                ...
                                <tbody>
                                    @foreach ($testimonial as $k => $p)
                                        <tr>
                                            ...
                                            <td><b>{{ $p->title }}</b></td>
                                            <td>
                                                <img class="img-responsive" width="100%" src="{{ asset('assets/images/post') }}/{{ $p->image }}">
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('staff-post-edit', $p->id) }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('staff-post-delete') }}" class="form-inline">
                        {!! csrf_field() !!}
                        {{ method_field('DELETE') }}
    ...
    <div class="modal fade" id="StatusModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('staff-post-publish') }}" class="form-inline">
                        {!! csrf_field() !!}
