        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('staff-manual-payment-request-confirm') }}" class="form-inline">
                        {!! csrf_field() !!}
    ...
    <div class="modal fade" id="DelModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('staff-manual-payment-request-cancel') }}" class="form-inline">
                        {!! csrf_field() !!}
