            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form class="md-float-material" action="{{ route('staff.login.post') }}" method="post">
                            {!! csrf_field() !!}
                            ...
                            <div class="auth-box">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center txt-primary">Staff Login</h3>
                                    </div>
                                </div>
                                <hr />
                                ...
                                <div class="row m-t-25 text-left">
                                    <div class="col-12">
                                        ...
                                        <div class="forgot-phone text-right f-right">
                                            <a href="{{ route('staff.password.request') }}" class="text-right f-w-600 text-inverse"> Forgot Password?</a>
                                        </div>
                                    </div>
                                </div>
