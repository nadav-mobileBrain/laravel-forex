                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="row">
                                <div class="col-md-6 offset-3">
                                    <textarea class="form-control text-center font-weight-bold" name="" id="" cols="30" rows="4" readonly>{{ $withdraw->details }}</textarea>
                                </div>
                            </div>
                            <br>
                            <br>
                            @if ($withdraw->status == 0)
                                <div class="row">
                                    <div class="col-md-3 offset-3">
                                        <button type="button" class="btn btn-warning btn-block text-uppercase btn-lg delete_button" data-toggle="modal" data-target="#refundModal" data-id="{{ $withdraw->id }}" title="Refund">
                                            <i class='fa fa-retweet'></i> Refund
                                        </button>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6 offset-3">
                                        <button type="button" class="btn btn-warning btn-block text-uppercase btn-lg">
                                            <i class='fa fa-retweet'></i> Refunded
                                        </button>
                                    </div>
                                </div>
                            @endif
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('staff-withdraw-confirm') }}" class="form-inline">
                        {!! csrf_field() !!}
    ...
    <div class="modal fade" id="refundModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('staff-withdraw-refund') }}" class="form-inline">
                        {!! csrf_field() !!}
                        <input type="hidden" name="id" value="{{ $withdraw->id }}">
                        <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>&nbsp;&nbsp;
                        <button type="submit" class="btn btn-danger"><i class="fa fa-check"></i> YES Sure</button>
