    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
            ...
            @php
                ...
                $allSignal = App\Models\SignalPlan::wherePlan_id($planId)->count();
            @endphp
                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <div class="pcoded-navigation-label">Manage Referral Bonus</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="{{ Request::is('user/referral-user') ? 'active' : '' }}">
                                    <a href="{{ route('user-referral-user') }}">
                                        <span class="pcoded-micon"><i class="ti-user"></i><b>D</b></span>
                                        <span class="pcoded-mtext">Referral Users</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                ...
                                <li class="{{ Request::is('user/withdraw-now') ? 'active' : '' }}">
                                    <a href="{{ route('user-withdraw-now') }}">
                                        <span class="pcoded-micon"><i class="ti-control-shuffle"></i><b>D</b></span>
                                        <span class="pcoded-mtext">Withdraw Now</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="{{ Request::is('user/withdraw-history') ? 'active' : '' }}">
                                    <a href="{{ route('user-withdraw-history') }}">
                                        <span class="pcoded-micon"><i class="ti-view-list-alt"></i><b>D</b></span>
                                        <span class="pcoded-mtext">Withdraw Log</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            </ul>
                            <div class="pcoded-navigation-label">Manage Notification</div>
                            <ul class="pcoded-item pcoded-left-item">

                                <li class="{{ Request::is('user/active-whatsapp') ? 'active' : '' }}">
                                    <a href="{{ route('user-active-whatsapp') }}">
                                        <span class="pcoded-micon"><i class="fa fa-whatsapp"></i><b>D</b></span>
                                        <span class="pcoded-mtext">Active Whatsapp</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>

                                <li class="{{ Request::is('user/active-telegram') ? 'active' : '' }}">
                                    <a href="{{ route('user-active-telegram') }}">
