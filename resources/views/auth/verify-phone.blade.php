            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2 col-sm-12">
                    <div class="area-heading text-center">
                        <h2 class="area-title">Verify Your Phone Number</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-md-offset-3 col-sm-12">
                    ...
                    <form class="m-t-20" action="{{ route('phone-verification-submit') }}" autocomplete="off" method="post" data-aos="fade-left" data-aos-duration="1200">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <button type="submit" class="btn btn-lg btn-primary btn-block btn-arrow"><span> Verify Now <i class="ti-arrow-right"></i></span></button>
                                <!--  -->
                            </div>
                        </div>
                    </form>
